...
class Player:
    ...
    def setImg( self, address):
        #right
        self.img = pygame.image.load(address+".png").convert_alpha()
        self.img = pygame.transform.scale(self.img, (self.size*2, self.size*2))
        #left
        self.img2 = pygame.image.load(address+"2.png").convert_alpha()
        self.img2 = pygame.transform.scale(self.img2, (self.size*2, self.size*2))
    ...
    def draw( self, screen):
        if self.img == None:
            ...
            screen.blit(self.img2, (self.x, screen.get_height() - self.y))
